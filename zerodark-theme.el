...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(ivy-minibuffer-match-face-2 ((,class (:background ,grey-dark :weight bold))))
   `(ivy-minibuffer-match-face-3 ((,class (:background ,grey-dark :weight bold))))
   `(ivy-minibuffer-match-face-4 ((,class (:background ,grey-dark :weight bold))))
